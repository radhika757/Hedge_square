...
<section class="section-top-vart-40 section-bottom-vart-20">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="section-title title-center"><h2>Directors</h2></div>
			</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
				<div class="card">
					<div class="card-body text-center">
						<p><img src="assets/images/team/Hemant.jpg" alt="Hemant Shah"></p>
						<h4 class="card-title">Hemant Shah</h4>
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
				<div class="card">
					<div class="card-body text-center">
						<p><img src="assets/images/team/Nikhil.jpg" alt="Nikhil Anand"></p>
						<h4 class="card-title">Nikhil Anand</h4>
						<!---<p class="card-text">Director</p>--->
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
				<div class="card">
					<div class="card-body text-center">
						<p><img src="assets/images/team/Samir.jpg" alt="Samir Gajjar"></p>
						<h4 class="card-title">Samir Gajjar</h4>
						<!---<p class="card-text">Director</p>--->
					</div>
				</div>
			</div>
